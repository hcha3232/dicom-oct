...
import useCornerstoneStack from './useCornerstoneStack';


export const DicomStacksViewer = ({dcmFileName, totalFrames=25}) => {
    const { divRef, currentFrame } = useCornerstoneStack(
        dcmFileName,
        totalFrames
    );
  ...
  export default DicomStacksViewer;
